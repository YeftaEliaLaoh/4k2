...
import com.example.a4k.libraries.testutils.TestCompatActivity
import com.example.a4k.libraries.testutils.TestFragmentActivity
...
class BaseFragmentTest : TestRobolectric() {
    ...
    class TestBaseFragment : com.example.a4k.commons.ui.base.BaseFragment<ViewDataBinding, ViewModel>(
        layoutId = 0
    ) {
