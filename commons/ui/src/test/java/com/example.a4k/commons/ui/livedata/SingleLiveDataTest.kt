package com.example.a4k.commons.ui.livedata
...
import com.example.a4k.libraries.testutils.lifecycle.TestLifecycleOwner
...
class SingleLiveDataTest {
    ...
    fun observingSingleLiveData_WhenPostStringValue_ShouldTriggerOneEvent() {
        val singleLiveData = com.example.a4k.commons.ui.livedata.SingleLiveData<String>()
    ...
    fun observingSingleLiveData_WhenPostMultipleIntValue_ShouldTriggerMultipleTimes() {
        val singleLiveData = com.example.a4k.commons.ui.livedata.SingleLiveData<Int>()
